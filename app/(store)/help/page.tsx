        ...
        >
          <div className="relative">
            <input
              ...
              className="w-full px-6 py-4 pl-14 rounded-xl text-gray-900 text-lg focus:outline-none focus:ring-4 focus:ring-blue-300/80"
            />
            <i className="ri-search-line absolute left-5 top-1/2 -translate-y-1/2 text-2xl text-gray-400" />
            {searchQuery && (
              <button
                type="button"
          ...
          {searchQuery && filteredArticles.length > 0 && (
            <div className="mt-4 bg-white rounded-xl shadow-lg text-left max-h-96 overflow-y-auto">
          ...
          {searchQuery && filteredArticles.length === 0 && (
            <div className="mt-4 bg-white rounded-xl shadow-lg p-6 text-center">
              <i className="ri-file-search-line text-4xl text-gray-400 mb-2" />
