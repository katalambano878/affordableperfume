...
const nextConfig: NextConfig = {
  images: {
    // sharp-backed /_next/image returns empty bodies on this Coolify/nixpacks image;
    // serve originals until the optimizer runtime is healthy.
    unoptimized: true,
    formats: ['image/webp'],
    ...
    remotePatterns: [
      ...
      {
        protocol: 'https',
        hostname: 'www.affordableperfumesgh.com',
        pathname: '/storage/**',
      },
      {
        protocol: 'https',
        hostname: 'affordableperfumesgh.com',
        pathname: '/storage/**',
      },
      {
        protocol: 'https',
        hostname: 'affordableperfume.169-58-8-203.sslip.io',
        pathname: '/storage/**',
      },
      {
        protocol: 'https',
